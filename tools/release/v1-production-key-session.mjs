...
const directory = join(tmpdir(), 'cyber-v1-production-Po3xh7');
...
try {
  ...
  const response = await context.request.post(`${origin}/api/developer/api-keys`, {
    ...
    data: {
      label: isolation ? 'CUSTOMER_ZERO_V1_ISOLATION_20260909' : 'CUSTOMER_ZERO_V1_PRODUCTION_20260909', environment: 'live',
