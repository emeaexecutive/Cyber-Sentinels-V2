        ...
        <section className="rounded-lg border border-zinc-800 bg-zinc-950 p-6">
          ...
          <div className="mt-4 flex flex-wrap items-start justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link href="/replay/demo" className="rounded-lg border border-zinc-700 px-4 py-2 text-sm text-zinc-300 hover:text-white">
                Open Demo Replay Timeline
              </Link>
              <Link href="/trust/receipt/demo" className="rounded-lg border border-zinc-700 px-4 py-2 text-sm text-zinc-300 hover:text-white">
                Open Demo Verification Receipt
              </Link>
            </div>
          </div>
        </section>
