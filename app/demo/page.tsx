...
const demoSequence = ["Identity","Authority","Declared environment","Observed environment","Permitted scope","Decision evidence","Trust-state change","Incident response","Reviewer decision","Corrective action","Package formation","Full Replay"];
...
export default function DemoPage(){const scenario=epic2627CrossEpicScenario();const demonstrationContract = [
  ...
  ["What containment occurred?", "Containment was requested and provider-acknowledged, but remains unconfirmed."],
  ...
  ["How is the complete sequence replayed?", "The Enterprise Trust Timeline projects Epic 26 and 27 records, corrective action and the digest-bound draft package without duplicating canonical sources."],
