...
const demoSequence = ["Identity","Authority","Declared and observed environment","Permitted scope","Decision evidence","Trust-state change","Operational response","Replay"];
const demonstrationContract = [
  ...
  ["What environment was declared and observed?", "Environment Attestation keeps assertions separate from observations."],
  ...
  ["What changed the trust state?", "Deterministic reason codes connect contradictions and signals to the state transition."],
  ["What happened next?", "Human review, pause, restriction, suspension or revocation remains visible."],
  ["How can it be replayed?", "The Enterprise Trust Timeline projects Replay, Trust Memory and incident chronology."],
] as const;

export default function DemoPage(){return <main className="min-h-screen bg-[#04070c] px-6 py-12 text-white md:px-8"><div className="mx-auto max-w-6xl">
