          ...
          <aside aria-label="Illustrative authority decision" className="min-w-0 rounded-2xl border border-zinc-800 bg-[#070b12] p-5 sm:p-6">
            ...
            <div className="mt-6 divide-y divide-zinc-800 text-sm">
              ...
              <div className="flex items-start justify-between gap-4 py-4">
                <dl><dt className="text-zinc-400">Policy decision</dt><dd className="mt-1 max-w-64 leading-6 text-zinc-200">Amount exceeds delegated authority.</dd></dl>
                <span className="rounded-md border border-red-400/30 bg-red-400/10 px-3 py-1.5 font-semibold text-red-300">DENY</span>
              </div>
            </div>
            <p className="border-t border-zinc-800 pt-4 text-xs leading-6 text-zinc-400">Evidence stored <span aria-hidden="true">·</span> Receipt created <span aria-hidden="true">·</span> Replay available</p>
          </aside>
        </div>
      </section>
      ...
      <section className="border-b border-zinc-800">
        <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
          ...
          <div className="mt-8 grid gap-8 md:grid-cols-2 md:gap-12">
            <article>
              <h3 className="text-xl font-semibold text-white">Incident evidence, connected.</h3>
            ...
            <article>
              <h3 className="text-xl font-semibold text-white">Trust Memory keeps the history.</h3>
