    ...
    <>
      <div className="border-b border-zinc-800 bg-[#04070c] px-6 py-3 text-white md:px-8">
        <nav className="mx-auto flex max-w-6xl flex-wrap items-center gap-4 text-sm">
          ...
          <Link href="/demo" className="text-cyan-200 hover:text-white">Demo Overview</Link>
          <Link href="/demo/hiring-attack" className="text-cyan-200 hover:text-white">Hiring Security</Link>
          ...
          <Link href="/enterprise-access" className="ml-auto rounded-md bg-white px-3 py-1.5 font-semibold text-black">Enterprise Access</Link>
        </nav>
      </div>
      {children}
    </>
