...
export const metadata: Metadata = {
  ...publicSocialMetadata("Mission | Cyber Sentinels", "The Cyber Sentinels mission and principles for evidence-backed, human-governed operational trust.", "/about/mission"),
