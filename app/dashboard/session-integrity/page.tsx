      ...
      <div className="mx-auto max-w-7xl">
        <section className="rounded-lg border border-zinc-800 bg-zinc-950 p-6">
          ...
          <p className="mt-4 max-w-3xl text-sm leading-7 text-zinc-400">
            Review liveness, media risk, injection risk, device continuity and channel integrity
            as separate evidence. Human reviewers retain authority over the workflow decision.
          </p>
