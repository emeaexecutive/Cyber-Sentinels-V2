...
export const canonicalPublicRoutes = [
  ...
  "/governance",
  "/resources/agent-security",
  "/resources/agent-security/agent-authorization",
  "/resources/agent-security/mcp-tool-authorization",
  "/resources/agent-security/synthetic-interaction-trust",
  "/documents",
