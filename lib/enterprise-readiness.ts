...
export function buildEnterpriseReadinessModel(
  ...
  return {
    ...
    settingsGroups: [
      { label: "Enterprise Settings", href: "/enterprise/operations", description: "Tenant configuration ownership and environment boundaries." },
      { label: "Enterprise Policies", href: "/admin/trust-architecture/policies", description: "Versioned trust rules, approvals and rollback references." },
      { label: "Enterprise Roles", href: "/team-access", description: "Tenant roles and access boundaries." },
      { label: "Enterprise Teams", href: "/team-workspace", description: "Workspace membership and operational ownership." },
      { label: "Enterprise Integrations", href: "/admin/integrations", description: "Provider and workflow integration controls." },
      { label: "Enterprise API Keys", href: "/developers/api-keys", description: "Scoped developer credentials and audit metadata." },
      { label: "Enterprise Webhooks", href: "/admin/integrations", description: "Signed callback processing and event-ledger status." },
      { label: "Enterprise Notifications", href: "/notifications", description: "Operator alerts and accountable next actions." },
      { label: "Enterprise Exports", href: "/compliance-export", description: "Point-in-time evidence and compliance exports." },
      { label: "Enterprise Reports", href: "/trust-center", description: "Executive and audit-oriented trust reporting." },
