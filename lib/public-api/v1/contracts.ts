...
export const PUBLIC_API_ERROR_CODES = [
  ...
  "HEARTBEAT_INVALID_ENVELOPE",
  "HEARTBEAT_INVALID_EVENT_ID",
  "HEARTBEAT_INVALID_TIMESTAMP",
  "HEARTBEAT_INVALID_SIGNATURE",
  "HEARTBEAT_ENVIRONMENT_MISMATCH",
  "CONTROL_PLANE_UNAVAILABLE",
  "CONTROL_PLANE_BASELINE_MISSING",
  "CONTROL_PLANE_ENVIRONMENT_MISMATCH",
  "CONTROL_PLANE_ENTITY_MISMATCH",
  "CONTROL_PLANE_CREDENTIAL_BINDING_MISMATCH",
  "CONTROL_PLANE_CREDENTIAL_NOT_CURRENT",
  "CONTROL_PLANE_MANIFEST_NOT_CURRENT",
  "CONTROL_PLANE_VERIFICATION_NOT_CURRENT",
  "CONTROL_PLANE_IDENTITY_CLAIMS_INCOMPLETE",
  "CONTROL_PLANE_IDENTITY_NOT_CURRENT",
  "CONTROL_PLANE_AUTHORITY_NOT_CURRENT",
  "CONTROL_PLANE_POLICY_NOT_CURRENT",
  "CONTROL_PLANE_OWNER_MISMATCH",
  "CONTROL_PLANE_FINGERPRINT_MISMATCH",
  "CONTROL_PLANE_MANIFEST_SIGNATURE_INVALID",
  "CONTROL_PLANE_BASELINE_LINKAGE_MISMATCH",
  "CONTROL_PLANE_POLICY_AUTHORITY_MISMATCH",
  "CONTROL_PLANE_MANIFEST_AUTHORITY_MISMATCH",
  "CONTROL_PLANE_SIGNED_CLAIMS_MISMATCH",
  "RATE_LIMITED",
