...
export const identityReasonCodes = [
  ...
  "WORLD_ID_NULLIFIER_REPLAY",
  "WORLD_ID_PROVIDER_UNAVAILABLE",
  "WORLD_ID_REPLAY_STORE_UNAVAILABLE",
  "WORLD_ID_PROVIDER_VERIFICATION_FAILED",
  "WORLD_ID_PROVIDER_VERIFIED",
  "WORLD_ID_SERVER_VERIFICATION_NOT_IMPLEMENTED",
  "WORLD_ID_SIGNATURE_INVALID",
  "WORLD_ID_SIGNATURE_MISSING",
  "WORLD_ID_VERIFIED",
] as const;
