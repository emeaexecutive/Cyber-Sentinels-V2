...
alter table public.enterprise_access_requests add column if not exists name text;
alter table public.enterprise_access_requests add column if not exists work_email text;
...
alter table public.enterprise_access_requests add column if not exists message text;
alter table public.enterprise_access_requests add column if not exists status text default 'new';
alter table public.enterprise_access_requests add column if not exists created_at timestamptz default now();
alter table public.enterprise_access_requests add column if not exists updated_at timestamptz default now();
