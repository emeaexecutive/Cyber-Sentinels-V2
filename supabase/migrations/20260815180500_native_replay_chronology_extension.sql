-- Extend native Replay chronology with capability-governance relationship,
-- authority-intersection, compatibility, and conflict evaluations.
...
alter table public.operational_entity_native_replay_events
  ...
  check(event_type in (
    ...
    'RELATIONSHIP_OBSERVED','AUTHORITY_INTERSECTION_EVALUATED','INTER_AGENT_COMPATIBILITY_EVALUATED','INTER_AGENT_CONFLICT_EVALUATED'
  ));
