...
-- STAGING TEST ONLY - shared concurrent RPC invocation for session B.
--
-- This is the same call as the SELECT in 004_concurrent_session_a.sql without
-- the surrounding transaction or delay.
