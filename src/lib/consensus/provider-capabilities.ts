...
export function providerCapabilities(env: Record<string, string | undefined> = process.env): ProviderCapability[] {
  ...
  return [
    { providerKey: "hopae_connect", displayName: "Hopae Connect", version: "consensus-capability-v2", state: hopaeState, baseWeight: hopaeState === "ACTIVE" ? 0.9 : 0, positiveEvidence: hopaeState === "ACTIVE", supportedSignals: ["identity_verification", "document_verification", "government_identity"], independenceGroup: "government_identity", cryptographicVerificationRequired: true, serverVerificationRequired: true, freshnessWindowSeconds: 86_400, reasonCodes: hopaeState === "ACTIVE" ? ["HOPAE_SIGNED_SERVER_VERIFIED_PATH_AVAILABLE"] : [hopaeState === "BLOCKED" ? "HOPAE_CREDENTIALS_INCOMPLETE" : "HOPAE_DISABLED"] },
