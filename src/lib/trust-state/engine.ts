...
export function evaluateTrustState(input: { contract: TrustDecisionContract; priorState: TrustState; recommendation: TrustStateRecommendation; evidence: unknown[]; policy: TrustStatePolicy; decidedAt?: string }): TrustStateDecision {
