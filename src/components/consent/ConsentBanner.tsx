...
export function ConsentBanner({ busy, error, onAcceptAll, onRejectOptional, onManage }: { busy: boolean; error?: string | null; onAcceptAll: () => void; onRejectOptional: () => void; onManage: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end bg-black/70 p-3 sm:items-center sm:justify-center" role="presentation">
